          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="flex items-center group">
              <div className="relative">
                <span className="font-display text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-sm">
                  Uygunlar Ev Tekstil
                </span>
                <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-400 group-hover:w-full transition-all duration-500" />
              </div>
            </Link>
            ...
            >
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mb-8">
                  <span className="font-display text-xl font-bold bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 bg-clip-text text-transparent">Uygunlar Ev Tekstil</span>
                  <button
                    onClick={closeMobileMenu}
